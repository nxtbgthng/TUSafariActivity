Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/nxtbgthng/TUSafariActivity"
  ...
  s.source       = { :git => "https://github.com/nxtbgthng/TUSafariActivity.git", :tag => s.version.to_s }
  s.platform     = :ios, '6.0'
  s.source_files = 'TUSafariActivity/*.{h,m}'
  s.resources    = 'TUSafariActivity/*.bundle'
  s.requires_arc = true
end
